...
namespace AutoServiss.Client.Services
{
    public class AuthService : IAuthService
    {
        ...
        {
            var loginAsJson = JsonSerializer.Serialize(loginQuery);
            ...
            ((ApiAuthenticationStateProvider)_authenticationStateProvider).MarkUserAsAuthenticated(loginQuery.Email);
